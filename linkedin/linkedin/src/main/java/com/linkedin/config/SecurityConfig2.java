...
//                                "/app/**",     // STOMP messages
//                                "/topic/**"    // STOMP subscriptions
//                        ).permitAll()
//
//                        .requestMatchers("/api/admin/**").hasAuthority("ADMIN")
//
//                        .requestMatchers(HttpMethod.POST, "/api/jobs").hasAnyAuthority("COMPANY", "ADMIN")
//                        .requestMatchers(HttpMethod.GET, "/api/jobs/**").hasAnyAuthority("USER", "COMPANY", "ADMIN")
...
//                        .requestMatchers(HttpMethod.POST, "/api/profile/experience").hasAnyAuthority("USER", "COMPANY", "ADMIN")
//                        .requestMatchers(HttpMethod.POST, "/api/profile/education").hasAnyAuthority("USER", "COMPANY", "ADMIN")
//                        .requestMatchers(HttpMethod.GET, "/api/posts/user/**").hasAnyAuthority("USER", "COMPANY", "ADMIN")
//                        .requestMatchers(
//                                "/api/profile/**",
//                                "/api/posts/**",
//                                "/api/comments/**",
